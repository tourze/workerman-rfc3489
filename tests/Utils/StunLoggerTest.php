 ...
 * @internal
 */
#[CoversClass(StunLogger::class)]
final class StunLoggerTest extends TestCase
{
    ...
    public function testLogWithNullLogger(): void
    {
    ...
    public function testLogWithLogger(): void
    {
        $mockLogger = $this->createMock(LoggerInterface::class);
    ...
    public function testGetInternalLogger(): void
    {
        $mockLogger = $this->createMock(LoggerInterface::class);
        $stunLogger = new StunLogger($mockLogger);
    ...
    public function testSetInternalLogger(): void
    {

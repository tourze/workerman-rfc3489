...
{
    public function testCreateBindingRequest(): void
    {
    ...
    public function testCreateBindingRequestWithTransactionId(): void
    {
    ...
    public function testCreateBindingResponse(): void
    {
        $transactionId = str_repeat("\xAB", 16);
    ...
    public function testCreateBindingErrorResponse(): void
    {
        $transactionId = str_repeat("\xAB", 16);
        ...
        $this->assertInstanceOf(ErrorCodeAttribute::class, $errorCodeAttr);
        /* @var ErrorCodeAttribute $errorCodeAttr */
        $this->assertSame(ErrorCode::SERVER_ERROR->value, $errorCodeAttr->getCode());
        $this->assertSame($reason, $errorCodeAttr->getReason());
    }

    public function testCreateBindingErrorResponseWithDefaultReason(): void
    {
        $transactionId = str_repeat("\xAB", 16);
        $errorCode = ErrorCode::SERVER_ERROR;
    ...
    public function testCreateSharedSecretRequest(): void
    {
    ...
    public function testCreateSharedSecretRequestWithTransactionId(): void
    {
        $transactionId = str_repeat("\xAB", 16);
    ...
    public function testCreateSharedSecretResponse(): void
    {
        $transactionId = str_repeat("\xAB", 16);
        $username = 'testuser';
        $password = 'testpass';
    ...
    public function testCreateSharedSecretErrorResponse(): void
    {
        $transactionId = str_repeat("\xAB", 16);
    ...
    public function testAddMessageIntegrity(): void
    {
        $message = MessageFactory::createBindingRequest();
    ...
    public function testAddServerAddresses(): void
    {
        ...
        $this->assertInstanceOf(SourceAddress::class, $sourceAddress);
        ...
        $this->assertInstanceOf(ChangedAddress::class, $changedAddress);
        /* @var ChangedAddress $changedAddress */
        $this->assertSame($changedIp, $changedAddress->getIp());
        $this->assertSame($changedPort, $changedAddress->getPort());
    }

    public function testAddReflectedFrom(): void
    {
        $message = MessageFactory::createBindingResponse(str_repeat("\xAB", 16), '192.168.1.1', 8080);
        ...
        $this->assertInstanceOf(ReflectedFrom::class, $reflectedFrom);
        /* @var ReflectedFrom $reflectedFrom */

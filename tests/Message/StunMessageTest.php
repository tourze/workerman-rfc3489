 ...
 * @internal
 */
#[CoversClass(StunMessage::class)]
final class StunMessageTest extends TestCase
{
    ...
    public function testGetSetMessageType(): void
    {
    ...
    public function testGetMessageLength(): void
    {
        $message = new StunMessage(Constants::BINDING_REQUEST);
        ...
        $actualLength = $message->getMessageLength();
        $this->assertEquals($expectedLength, $actualLength, '消息长度计算错误');
    }
    ...
    public function testAddGetAttributes(): void
    {
        $message = new StunMessage(Constants::BINDING_REQUEST);
    ...
    public function testGetAttributeByType(): void
    {
        $message = new StunMessage(Constants::BINDING_REQUEST);
    ...
    public function testEncode(): void
    {
        ...
        // 检查消息类型
        $typeData = unpack('n', substr($encoded, 0, 2));
        $this->assertNotFalse($typeData);
        $encodedType = $typeData[1];
    ...
    public function testAddAttribute(): void
    {
        ...
        // 添加第一个属性
        $username = new Username('testuser');
        $result = $message->addAttribute($username);
        ...
        $attributes = $message->getAttributes();
        $this->assertCount(1, $attributes);
        $this->assertContains($username, $attributes);
        ...
        $this->assertCount(2, $attributes);
        $this->assertContains($username, $attributes);
        $this->assertContains($mappedAddress, $attributes);
    }

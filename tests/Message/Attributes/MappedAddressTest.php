 ...
 * @internal
 */
#[CoversClass(MappedAddress::class)]
final class MappedAddressTest extends TestCase
{
    ...
    public function testEncodeIpv6(): void
    {
        $ip = '2001:db8::1';
        $port = 8080;
        $mappedAddress = new MappedAddress($ip, $port);
    ...
    public function testDecodeIpv6(): void
    {
        $ip = '2001:db8::1';
        $port = 8080;
        ...
        $this->assertNotFalse(filter_var($mappedAddress->getIp(), FILTER_VALIDATE_IP, FILTER_FLAG_IPV6));
        $this->assertSame($port, $mappedAddress->getPort());
    }

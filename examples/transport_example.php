    ...
    if ($result) {
        ...
        if ($response !== null) {
            ...
            if ($message->getTransactionId() === $request->getTransactionId()) {
                ...
                // 提取映射地址
                $mappedAddress = $message->getAttribute(\Tourze\Workerman\RFC3489\Message\AttributeType::MAPPED_ADDRESS);
            ...
            if ($transport->getLastError() !== null) {

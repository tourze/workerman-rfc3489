 ...
 */
class SourceAddress extends MessageAttribute
{
    /**
     * 地址族
     */
    ...
    public function __construct(
        ...
        parent::__construct(AttributeType::SOURCE_ADDRESS);
    ...
    {
        return sprintf('SOURCE-ADDRESS: %s', IpUtils::formatAddressPort($this->ip, $this->port));
    }
}
